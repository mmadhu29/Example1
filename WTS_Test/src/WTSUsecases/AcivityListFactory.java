...
import WTSUsecases.AcivityListTest;

public class AcivityListFactory {
     ...
     public Object[] factoryMethod() {
    	 ...
    	 Activities_Array = new AcivityListTest[rowstoexecute];
    	 XlsReader xls = new XlsReader(System.getProperty("user.dir") + System.getProperty("file.separator") + "data"+ System.getProperty("file.separator") +"TestData.xlsx");
    	 int arrayCnt = 0;
    	 for (int rows = 2; rows <= xls.getRowCount(this.SheetName); rows++) 
         {
                ...
                {
                	AcivityListProperties newProp = new AcivityListProperties();
                      ...
                      Activities_Array[arrayCnt] = new AcivityListTest(newProp);
                      arrayCnt++; 
                }
         }
